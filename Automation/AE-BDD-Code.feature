...
Scenario Outline: Verify CoL Member and Portfolio and CoL Citi Settlement account No fields are visible and mandatory in single portfolio when service type is Corporation of Lloyds for Corporate Organisation
